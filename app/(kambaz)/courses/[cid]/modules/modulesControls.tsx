...
export default function ModulesControls() {
 return (
   <div id="wd-modules-controls" className="text-nowrap">
     <Button variant="danger" size="lg" className=" btn-tight float-end" id="wd-add-module-btn">
     ...
     <Button variant="secondary" size="lg" className="btn-tight me-1 float-end" id="wd-view-progress">
       View Progress
     </Button>
     <Button variant="secondary" size="lg" className="btn-tight me-1 float-end" id="wd-collapse-all">
       Collapse All
     </Button>
