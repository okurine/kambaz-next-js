...
export default function CourseNavigation() {
  return (
    <div id="wd-courses-navigation">
      ...
      <a href="https://piazza.com/" id="wd-course-piazza-link" target="_blank">Piazza</a><br/>
      {/* <Link href="/courses/1234/zoom" id="wd-course-zoom-link">Zoom</Link><br/> */}
      <a href="https://zoom.us/signin#/login" id="wd-course-zoom-link" target="_blank">Zoom</a><br/>
