...
export default function AssignmentEditor() {
  ...
  const save = async () => {
    if (existingAssignment) {
      ...
      const created = await client.createAssignment(cid as string, assignment);
    ...
    <div id="wd-assignments-editor" className="p-4">
      ...
      <div style={{ maxWidth: "700px" }}>
        ...
        <Row className="align-items-start mb-4">
          ...
          <Col sm={9}>
            <div className="border rounded p-3">
              <label htmlFor="wd-assign-to" className="fw-bold mb-1">
                Assign to
              </label>
              <FormControl
                id="wd-assign-to"
                ...
                className="mb-3"
              />
              <label htmlFor="wd-due-date" className="fw-bold mb-1">
                Due
              </label>
              <FormControl
                type="date"
              ...
              <Row>
                <Col>
                  <label htmlFor="wd-available-from" className="fw-bold mb-1">
                    Available from
                  </label>
                  <FormControl
                    type="date"
                ...
                <Col>
                  <label htmlFor="wd-available-until" className="fw-bold mb-1">
                    Until
                  </label>
                  <FormControl
                    type="date"
